...
```text
ghcr.io/guyao146/sakura-mcp-server:0.2.23
```
...
```dotenv
SAKURA_MCP_IMAGE=ghcr.io/guyao146/sakura-mcp-server:0.2.23
```
...
`v0.1.0` 是早期安全 MCP 网关版本；当前 `main` 的应用版本为 `v0.2.23`，对应 GHCR 镜像和生产 Compose 部署版本。
