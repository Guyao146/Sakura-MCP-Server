...
function authData(){return{issuer:$('issuer').value,audience:$('audience').value,jwksUri:$('jwksUri').value,scopeClaim:$('scopeClaim').value,clientId:$('clientId').value,authorizationUrl:$('authorizationUrl').value,tokenUrl:$('tokenUrl').value,userinfoUrl:$('userinfoUrl').value||undefined,endSessionUrl:$('endSessionUrl').value||undefined}}
